...
-- Interrogazioni
select Neg_Cod from Ordini;
select distinct Neg_Citta from Negozi;
select Neg_Cod as Codice, Neg_Nome as Denominazoine, Neg_Indirizzo as Indirizzo, Neg_Citta as Città, Neg_Telefono as Telefono from Negozi;
select Neg_Cod Codice, Neg_Nome Denominazoine, Neg_Indirizzo Indirizzo, Neg_Citta Città, Neg_Telefono Telefono from Negozi;  -- Alternativa
select * from Articoli where Art_Spese_Trasporto > 20 and Art_Prezzo * (1 + Art_Iva/100) < 500;
select * from Componenti where Com_Descrizione like '%tavolo%';
select Com_Cod from CompArt natural join (select * from Articoli where Art_Descrizione = 'Tavolo quadrato') as R1;
select Com_Cod from CompArt natural join Articoli where Art_Descrizione = 'Tavolo quadrato';  -- Alternativa
select Ord_Cod, Neg_Indirizzo, Art_Descrizione from Negozi natural join Ordini natural join OrdArt natural join Articoli;
select n1.* from Negozi n1 join Negozi n2 on n1.Neg_Citta = n2.Neg_Citta and n1.Neg_Cod != n2.Neg_Cod where n2.Neg_Nome = 'MobilMarket';
select a1.Art_Cod, a2.Art_Cod from Articoli a1 join Articoli a2 on a1.Art_Prezzo = a2.Art_Prezzo and a1.Art_Cod < a2.Art_Cod;